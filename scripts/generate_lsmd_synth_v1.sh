...
python tools/convert_datasets/generate_lsmd_t1fake_synth.py \
  --src-root data/lsmd_5186_final/tiles512_posaware_b2 \
  --src-split-dir data/lsmd_5186_final/splits_512_posaware_b2 \
  --train-split-name train.txt \
  --out-root data/lsmd_5186_final/tiles512_posaware_b2_synth_v1 \
